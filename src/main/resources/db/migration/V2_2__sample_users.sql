...
INSERT INTO  kingdom_table (kingdom_id, kingdom_name, pos_x, pos_y, last_update_time, user_id) VALUES (1, 'admin', 0, 0, 1487759590975, 1);
--INSERT INTO  building_table (building_id, hp, building_level, levelup_time, building_type, kingdom_id) values (10, 100, 1, 0, 'townhall', 1);
INSERT INTO RESOURCE_TABLE (resource_id, amount, resource_type, kingdom_id) values (77, 500, 'gold', 1);
INSERT INTO RESOURCE_TABLE (resource_id, amount, resource_type, kingdom_id) values (78, 500, 'food', 1);